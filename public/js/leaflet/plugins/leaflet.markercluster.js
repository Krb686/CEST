...
! function (t, e) {
    L.MarkerClusterGroup = L.FeatureGroup.extend({
        ...
        onAdd: function (t) {
            ...
            for (this._featureGroup.onAdd(t), this._nonPointGroup.onAdd(t), this._gridClusters || this._generateInitialClusters(), e = 0, i = this._needsRemoving.length; i > e; e++) n = this._needsRemoving[e], this._removeLayer(n);
